...
public class LockPatternView extends View
{
    ...
    private static final String FILE_HEADER = "position_x,position_y,velocity_x,velocity_y,pressure,size";
    ...
    public LockPatternView(Context context, AttributeSet attrs)
    {
        ...
        // Get the ALPActivity that is hosting this view
        host = (ALPActivity) getContext();
    ...
    private void testPracticePattern()
    {
        ...
        if(mPracticePattern.equals(mCurrentPattern))
        {
            ...
            testResult = "true";
            host.writeToFile(host.hw4data);
        }
        else{
            testResult = "false";
            host.clearDataBuffer();
        }
    ...
    {
        // Get the ALPActivity that is hosting this view
        ALPActivity host = (ALPActivity) getContext();
        ...
        switch(event.getAction())
        {
            case MotionEvent.ACTION_DOWN:
                ...
                // Write data file
                host.createDataString(event, 0, 0);
            ...
            case MotionEvent.ACTION_MOVE:
                        ...
                        && !mPracticePool.contains(mTouchCell))
                {
                    ...
                    // Write data file
                    host.createDataString(event, mVelocityTracker.getXVelocity(), mVelocityTracker.getYVelocity());
                }
                break;
            case MotionEvent.ACTION_UP:
                ...
                mVelocityTracker = null; // Null velocity tracker so as to not reuse the same tracker twice, which causes a fatal crash
